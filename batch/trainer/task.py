...
def train_and_evaluate(
    ...
    model_dir = os.path.join("/content/batch/data/model") # Comprobamos si ya existe un modelo
    if tf.io.gfile.exists(model_dir):
        tf.io.gfile.rmtree(model_dir) #si existe lo eliminamos
    tf.io.gfile.mkdir(model_dir) #creamos un directorio de model
...
if __name__ == "__main__":
    ...
    train_data_files = tf.io.gfile.glob(
        os.path.join("/content/batch/transformed_data/train/part-*") # el * permite que lea todas las particiones
    ) #archivos de entrenamiento
    eval_data_files = tf.io.gfile.glob(
        os.path.join("/content/batch/transformed_data/eval/part-*")
    ) #archivos de test
